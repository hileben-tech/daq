#ifndef PVC3252SSERPROTOCOL_H
#define PVC3252SSERPROTOCOL_H

#include "invserprotocol.h"

class Pvc3252sSerProtocol : public InvSerProtocol
{
    Q_OBJECT
...
public:
    explicit Pvc3252sSerProtocol(QObject *parent = 0);
